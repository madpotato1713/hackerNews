  ...
  NewsFeedView.prototype.render = function () {
    ...
    for (var i = (window.store.currentPage - 1) * 10; i < window.store.currentPage * 10; i++) {
      var _a = this.feeds[i],
          ...
          read = _a.read;
      this.addHtml(" \n            <div class=\"p-6 " + (read ? 'bg-blue-100' : 'bg-white') + " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                <div class=\"flex\">\n                    <div class=\"flex-auto\">\n                        <a href=\"#/show/" + id + "\">" + title + "</a>  \n                    </div>\n                    <div class=\"text-center text-sm\">\n                        <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">" + comments_count + "</div>\n                    </div>\n                </div>\n                <div class=\"flex mt-3\">\n                    <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n                        <div><i class=\"fas fa-user mr-1\"></i>" + user + "</div>\n                        <div><i class=\"fas fa-heart mr-1\"></i>" + points + "</div>\n                        <div><i class=\"far fa-clock mr-1\"></i>" + time_ago + "</div>\n                    </div>  \n                </div>\n            </div>\n            ");
    }
...
var NewsDetailView = function (_super) {
  ...
  function NewsDetailView(conatinerId) {
    return _super.call(this, conatinerId, template) || this;
  }
...
},{"./news-feed-view":"src/page/news-feed-view.ts","./news-detail-veiw":"src/page/news-detail-veiw.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
router.route();
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts"}],"C:/Users/shin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
