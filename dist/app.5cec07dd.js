...
},{"../core/view":"src/core/view.ts","../core/api":"src/core/api.ts","../config":"src/config.ts"}],"src/page/news-detail-veiw.ts":[function(require,module,exports) {
"use strict";
...
var NewsDetailView = /*#__PURE__*/function (_view_1$default) {
  ...
  function NewsDetailView(conatinerId, store) {
    var _this;

    _classCallCheck(this, NewsDetailView);

    _this = _super.call(this, conatinerId, template);
...
var news_detail_veiw_1 = require("./news-detail-veiw");

Object.defineProperty(exports, "NewsDetailView", {
  enumerable: true,
  get: function get() {
    return __importDefault(news_detail_veiw_1).default;
  }
});
},{"./news-feed-view":"src/page/news-feed-view.ts","./news-detail-veiw":"src/page/news-detail-veiw.ts"}],"src/store.ts":[function(require,module,exports) {
"use strict";
...
router.addRoutePath('/page/', newsFeedView, /page\/(\d+)/); // d+: 하나 이상의 연결된 숫자

router.addRoutePath('/show/', newsDetailView, /show\/(\d+)/);
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts","./store":"src/store.ts"}],"C:/Users/shin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9779" + '/');
...
},{}]},{},["C:/Users/shin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
